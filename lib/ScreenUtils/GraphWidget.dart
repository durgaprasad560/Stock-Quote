...
class Gainer_Graph_Present extends StatefulWidget {
  final String ticker;
  const Gainer_Graph_Present({super.key, required this.ticker});

  @override
  State<Gainer_Graph_Present> createState() => _Gainer_Graph_PresentState();
}

class _Gainer_Graph_PresentState extends State<Gainer_Graph_Present> {
  ...
  Future<void> fetchTopGainersData() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        var selectedStock = topGainers.firstWhere(
        ...
        if (selectedStock != null) {
          setState(() {
            ...
            stockSpots = topGainers.asMap().entries.map((entry) {
              int index = entry.key;
